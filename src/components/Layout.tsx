...
function Layout() {
  ...
  useEffect(() => {
    ...
    if (userID && storedRole === 'student') {
      fetch(`https://edutrackspring.up.railway.app/users/viewImage?id=${userID}`)
        .then((response) => {
          if (response.ok) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex flex-1">
        {/* Sidebar */}
        <aside
          className={`lg:w-64 w-full bg-white shadow-lg ${
